...
if platform.system() == "Windows":
    ...
    out_directory = Path(r"C:\Users\joe.nogosek\Documents\Python\autoReviews_testing")
else:
    out_directory = Path(r"C:\Users\joe.nogosek\Documents\Python\autoReviews_testing")

# Path of the Input pdf
PDF_file = Path(r"C:\Users\joe.nogosek\Documents\Python\autoReviews_testing\Shayla Moran - Line - 55718.pdf")
