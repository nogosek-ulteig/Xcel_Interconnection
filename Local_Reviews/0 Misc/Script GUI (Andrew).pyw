...
window.title("Andrew's Script GUI")
window.geometry('262x156')

# PSCo
def PSCo_updateTracker():
    os.system(r'python -i  C:\Users\andrew.norman\Documents\Local_Reviews\Colorado\updateTracker_PSCo - Copy.py')

def PSCo_setupFolders():
    os.system(r'python -i  C:\Users\andrew.norman\Documents\Local_Reviews\Colorado\setupFolders_PSCo - Copy.py')

def PSCo_batchProcessOneWindow():
    os.system(r'python -i  C:\Users\andrew.norman\Documents\Local_Reviews\Colorado\batchProcess_PSCo_oneWindow - Copy.py')

def PSCo_batchProcess():
    os.system(r'python -i  C:\Users\andrew.norman\Documents\Local_Reviews\Colorado\batchProcess_PSCo - Copy.py')

def PSCo_replaceChecklists():
    os.system(r'python -i  C:\Users\andrew.norman\Documents\Local_Reviews\Colorado\replaceChecklists_PSCo - Copy.py')

def PSCo_moveFolders():
    os.system(r'python -i  C:\Users\andrew.norman\Documents\Local_Reviews\Colorado\moveFolders - Copy.py')
